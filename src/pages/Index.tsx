  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Kamal‘s Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Kamal‘s Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Kamal‘s Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Kamal‘s Barbershop | Premium Barbershop Berlin" />
        <meta
